                ...
                <div className="bg-white max-w-md w-full h-800 p-8 rounded-lg shadow-lg space-y-4">
                    ...
                    <div className="bg-green-300 w-340 h-123 rounded-t-lg p-2  border-2 border-black flex flex-row ">
                        <div className="w-80 space-y-2 flex flex-row justify-start align items-center ">
                            ...
                            <Link to="/CropPlan" className=" mb- h-5 w-">Previous Task</Link>
                        </div>
                        <div className="w-80 space-y-2 flex flex-row justify-end align items-center">
                            <Link to="/NextTask2" className="h-5 w- ">Next Task</Link>
                    ...
                    <div className="bg-green-300 w- h-50 relative bottom-4 p-2 rounded-none p-2 border-2 border-t-0 border-black">
                        <div className="w-80 space-y-2  ">
                            ...
                            <p className="flex justify-center font-bold text-xl">Soil Testing</p>
                            <p className="flex justify-center">(40-16 days before sowing)</p>
                        </div>
                    </div>
                    <div className="bg-green-300 w- h-[64vh] relative bottom-8 p-2 rounded-b-lg  border-2 border-t-0 border-black">
                        <p className="mb=2 mt-2">Please get your soil tested at least one month before sowing. </p>
                        <p className="mb-2 mt-2">After harvesting of crop, remove any crop residue at the sampling spot, dig the soil in a V shaped hole with a depth of 15cm. Take samples from all corners and middle of field and mix well. Take 500 gm soil sample and get it tested in a soil testing laboratory.</p>
