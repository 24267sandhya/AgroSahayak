                ...
                <div className="bg-white max-w-md w-full h-800 p-8 rounded-lg shadow-lg space-y-4">
                    ...
                    <div className="bg-green-300 w-340 h-123 rounded-t-lg p-2  border-2 border-black flex flex-row ">
                        <div className="w-80 space-y-2 flex flex-row justify-start align items-center ">
                            ...
                            <Link to="/NextTask1" className=" mb- h-5 w-">Previous Task</Link>
                        </div>
                        <div className="w-80 space-y-2 flex flex-row justify-end align items-center">
                            <Link to="/NextTask3" className="h-5 w- ">Next Task</Link>
                    ...
                    <div className="bg-green-300 w- h-50 relative bottom-4 p-2 rounded-none p-2 border-2 border-t-0 border-black">
                        <div className="w-80 space-y-2  ">
                            ...
                            <p className="flex justify-center font-bold text-xl">Field Preparation</p>
                            <p className="flex justify-center">(15-11 days before sowing)</p>
                        </div>
                    </div>
                    <div className="bg-green-300 w- h-[64vh] relative bottom-8 p-2 rounded-b-lg  border-2 border-t-0 border-black">
                        <p className="mb=2 mt-2">The tillage after paddy cultivation is different from that of other crops. Well pulverized soil is required for uniform growth</p>
                        <p className="mb-2 mt-2">After Paddy crop: Zero tillage technology is preferred, to cut down the cost of wheat production without yield loss. In this method, seed and fertilizers are directly placed at proper depth by specially designed machines which create narrow slits. Harrow cultivation is not done.</p>
                        <p className="mb-2">After other Crops: Prepare the field by disc harrow and cultivator. Follow ploughing with planking for moisture conservation. Field should be well levelled. To conserve soil moisture, avoid deep cultivation. Bed planting in this method, bed formation, placement of fertilizer and sowing of seed is completed at once by bed planter. Row to row 15 to 20 cm space to be maintained. Furrows are used for irrigation as well as for drainage of excess water Apply 2 tons of Farm Yard Manure (FYM) or 400kg of Vermicompost per acre before planking.</p>
                    </div>
