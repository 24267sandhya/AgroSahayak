                ...
                <div className="bg-white max-w-md w-full h-800 p-8 rounded-lg shadow-lg space-y-4">
                    ...
                    <div className="bg-green-300 w-340 h-123 rounded-t-lg p-2  border-2 border-black flex flex-row ">
                        <div className="w-80 space-y-2 flex flex-row justify-start align items-center ">
                            ...
                            <Link to="/NextTask6" className=" mb- h-5 w-">Previous Task</Link>
                        </div>
                        
                    </div>
                    <div className="bg-green-300 w-340 h-50 relative bottom-4 p-2 rounded-none p-2 border-2 border-t-0 border-black">
                        <div className="w-80 space-y-2  ">
                            <p className="flex justify-center font-bold text-xl">Next Task</p>
                            <p className="flex justify-center font-bold text-xl">Boosting Spray</p>
                            <p className="flex justify-center">((16-20 days after sowing))</p>
                        </div>
                    </div>
                    <div className="bg-green-300 w-340 h-[64vh] relative bottom-8 p-2 rounded-b-lg  border-2 border-t-0 border-black">
                        <p className="mb=2 mt-2">In areas having manganese deficiency, Dissolve 1 kg Manganese sulphate in 200 litres of water and spray. Repeat again in a week. If there is only sulphur deficiency, apply Sulphur 80% WG water dispersible granules 3 kg per Acre. Spray should be done on a sunny day. </p>
                    </div>
