     ...
     <div className="bg-blue-500 min-h-screen flex justify-center items-center">
      ...
      <div className="bg-white-300 w-340 h-123 rounded-lg flex flex-col space-x-4">
          ...
          <div className="h-200 bg-white flex justify-center flex-col items-center">
            <div className="border-b-2 w-full border-green-800 p-1">
              <div className="text-lg flex justify-around items-center">
                <label className="w-40">pH: </label>
                <input type="number" value={ph} onChange={(e) => setPh(e.target.value)} className="border rounded w-40 border-black mx-3 my-1 p-1" />
              </div>  
            </div>
            ...
            <div className="border-b-2 w-full border-green-800 pl-1">
              <div className="text-lg flex justify-around items-center">
                <label className="w-40">Rainfall: </label>
                <input type="number" value={rainfall} onChange={(e) => setRainfall(e.target.value)} className="border rounded border-black w-40 mx-4 my-2 p-1" />
              </div>   
            </div>
          </div>  
        </div>
